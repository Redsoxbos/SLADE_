...
class PatchTransformerEncoder(nn.Module):
    def __init__(self, in_channels, patch_size=10, embedding_dim=128, num_heads=4):
        ...
        #self.positional_encodings = nn.Parameter(torch.rand(500, embedding_dim), requires_grad=True) 기존
        #수정
        #self.positional_encodings = nn.Parameter(torch.rand(1849, embedding_dim), requires_grad=True)
